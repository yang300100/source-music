...
**Goal:** 构建洛雪音乐鸿蒙版 MVP，实现音源导入、多音源搜索、音乐播放、歌单管理和歌词显示五大核心功能
...
export class JSSandbox {
  ...
  static async createSource(
    ...
    // 1. 注入 JSBridge.buildBridgeScript() 创建 lx 全局对象
    // 2. 执行 scriptContent
